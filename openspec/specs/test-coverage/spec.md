...
TBD - created by archiving change 'refactor-test-coverage'. Update Purpose after archive.
...
<!-- @trace
source: refactor-test-coverage
updated: 2026-04-07
code:
  - src/hooks/useGeneratePostalPDF.ts
  - src/hooks/useGeneratePDF.ts
  - src/constants/pdfCoordinates.ts
  - src/schemas/receiptSchema.ts
  - src/constants/formFields.ts
  - src/hooks/useGenerateMultiplePostalPDFs.ts
  - src/var/GlobalVariable.ts
  - src/utils/buildPDF.ts
  - src/hooks/useGenerateMultiplePDFs.ts
tests:
  - src/tests/hooks/useGenerateMultiplePDFs.test.ts
  - src/tests/hooks/useGenerateMultiplePostalPDFs.test.ts
  - src/tests/hooks/useGeneratePostalPDF.test.ts
  - src/tests/utils/buildPDF.test.ts
  - src/tests/utils/wrapTextByLength.test.ts
  - src/tests/hooks/usePDFHooks.test.ts
  - src/tests/utils/splitStringIntoGroups.test.ts
  - src/tests/hooks/useGeneratePDF.test.ts
-->
